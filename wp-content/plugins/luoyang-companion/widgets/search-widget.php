...
// Adds widget: Luoyang Search
class Luoyangsearch_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'luoyangsearch_widget',
			esc_html__( 'Luoyang Search', 'luoyang-companion' )
		);
	}
        ...
        <form action="<?php echo home_url();?>" method="GET">
            <div class="form-group">
                <div class="icon-field">
                    <i class="vl-search"></i>
                    <input type="text" name="s" class="form-control" placeholder="<?php echo esc_attr($instance['placeholder']);?>">
                </div>
            </div>
        </form>
        <?php
...
function register_luoyangsearch_widget() {
	register_widget( 'Luoyangsearch_Widget' );
}
add_action( 'widgets_init', 'register_luoyangsearch_widget' );